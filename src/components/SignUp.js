...
export default function SignUp({ setAlert, setSuccess }) {
  ...
  // API Utils
  const [fetchOccupationsAndStates, postUser] = API();

  useEffect(() => {
    fetchOccupationsAndStates().then((data) => {
  ...
  }, [fetchOccupationsAndStates, occupationList, stateList]);
  ...
  const [validLength, hasNumber, hasLetter, match, specialChar] =
              ...
              <div className="grid grid-cols-6 gap-5">
                ...
                <div className="col-span-6 sm:col-span-6">
                  ...
                  <input
                    ...
                    className={classNames(
                      btnClass(),
                      "text-black mt-1 block w-full rounded-md border py-2 px-3 shadow-sm sm:text-sm focus:outline-none placeholder-neutral-600"
                    )}
                  />
                </div>
